...
bastion_IP=51.250.95.158

someinternalhost_IP=10.128.0.34


ssh -i ~/.ssh/loa -J loa@51.250.95.158 loa@10.128.0.34,

или

ssh -i ~/.ssh/loa -J loa@bastion_IP loa@someinternalhost_IP,

    где 51.250.95.158 - внешний ip адрес машины bastion;

    10.128.0.34 - внутренний ip адрес  someinternalhost;
  ...
  vi ~/.ssh/config                                                                                                                         
  Host bastion
    HostName 51.250.95.158
    User loa
    Port 22
    ForwardAgent yes
    AddKeysToAgent yes
    IdentityFile ~/.ssh/loa
...
Last login: Fri Jun 17 11:48:04 2022 from 10.128.0.15
...
аходим на нашу панель управления по адресу: https://<bastion_IP>.sslip.io
 ...
 Логинимся, заходим в настройки, в LE Domain вводим имя хоста: 51.250.95.158.sslip.io
 ...
 loa@bastion:~$ sudo systemctl restart pritunl.service
 loa@bastion:~$ sudo systemctl status  pritunl.service
